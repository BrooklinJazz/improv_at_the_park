...
#
#     PHX_SERVER=true bin/improv_at_the_park start
#
...
if config_env() == :prod do
  ...
  config :improv_at_the_park, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :improv_at_the_park, ImprovAtThePark.Mailer,
